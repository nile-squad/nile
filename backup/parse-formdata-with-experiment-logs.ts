...
export async function parseBodyToStructured(
  ...
  try {
    ...
    console.log(
      '[parseBodyToStructured] Raw parsed body keys:',
      Object.keys(body)
    );
    console.log('[parseBodyToStructured] Raw body:', body);
    ...
    console.log('[parseBodyToStructured] Parsed fields:', Object.keys(fields));
    console.log('[parseBodyToStructured] Parsed files:', Object.keys(files));
    console.log(
      '[parseBodyToStructured] File count:',
    ...
    console.error('[parseBodyToStructured] Error:', error);
    return {
      status: false,
